...
module.exports = [
    ...
    {
        entry: './blockPalette/blockPalette.ts', // Entry point for blockPropertiesEditor
        output: {
            filename: 'blockPalette.js', // Output file
            path: path.resolve(__dirname, 'out/blockPalette'), // Match the output directory
        },
        resolve: {
            extensions: ['.ts', '.js'], // Resolve TypeScript and JavaScript files
            alias: {
            ...
            rules: [
                {
                    ...
                    use: {
                        loader: 'ts-loader',
                        options: {
                            configFile: path.resolve(__dirname, 'tsconfig.blockPalette.json'), // Use the new tsconfig file
                        },
                    },
                    exclude: /node_modules/,
                },
